 ...
 */
final class Version20231116141028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname CLOB NOT NULL, lastname CLOB NOT NULL, duckname CLOB NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE duck ADD COLUMN roles CLOB NOT NULL');
    }
}
